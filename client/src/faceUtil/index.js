...
export async function getFullFaceDescription(blob, inputSize = 512) {
    // we need to set a score threshold to determine between the positive and negative class. The higher the score threshold for face detection, the more strict for the detection with less result and vice versa.
