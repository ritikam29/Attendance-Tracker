            ...
            <Content>
                <Card>
                    ...
                    <Title level={2}>User Guidelines</Title>
                        ...
                        There are 2 user functionalities which are "Student" and "Lecturer"
                ...
                <Card>
                    <Row style={{ display: 'flex', justifyContent: 'flex-end'}}>
                        The website uses the API provided by: <a href="https://github.com/justadudewhohacks/face-api.js" target="_blank">face-api.js</a>
                    </Row>
